                    ...
                    <ul class="menu-links">
                        <li class="nav-link">
                            <a href="#" onclick="openDashB()">
                                ...
                                <span class="text" id="dtxt">Dashboard</span>
                            </a>
                            ...
                            <a href="../Learn-About-Donation/Learn-About-Donation.html" class="learndon">
                                ...
                                <span class="text" id ="ltxt">Learn About <br> Donation</span>
                            </a>
