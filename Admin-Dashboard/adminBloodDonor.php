<?php 
    ...
    $query = "SELECT * FROM donor_info_tbl WHERE don_boolBlood = 1 AND isNewApplicant = 0 AND isBloodAvailable = 1";
        ...
        <div class="adminNavigation .hide-for-mobile">
            ...
            <div class="adminLinks current">
                <a class="adminLinks__BloodDonor" href="./adminBloodDonor.php">
                    <img src="../Images/AdminDashboard/Icon-BloodDonor-current.svg" alt="Blood Donor Icon">
                    <h2>Blood Donor</h2>
                </a>
            </div>
            <div class="adminLinks">
            ...
            <div class="content-fixed-container">
                ...
                <div class="bloodDonor-function_container">
                    <div class="bloodDonor_add_container" onclick="dashboardopenPopup()">
                        ...
                        <svg class="bloodDonor-add-function-icon width=" 65" height="65" viewBox="0 0 65 65"
                        ...
                        <h2 class="bloodDonor-add-function-text">Add
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Blood Donor</h2>
                    </div>

                    <div class="bloodDonor-select-function_container">
                        <form method="GET" class="searchForm_function"> 
                            <div class="bloodDonor-search-function">
                                <input class="bloodDonor-search-input" type="text" name="search" id="" placeholder="Search">
                                <input type="submit" value="Search" class="searchForm_function__button">
                            </div>
                        </form>
                        <div class="bloodDonor-filter-function">
                            <svg class="bloodDonor-filter-function-icon" width="30" height="30" viewBox="0 0 30 30"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div  onclick="sortData('<?php echo $sortOrder; ?>')" class="bloodDonor-sort-function">
                            <svg class="bloodDonor-sort-function-icon" width="45" height="25" viewBox="0 0 45 25"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="adminbloodDonor">
                    <div class="adminbloodDonor__contentTitle">
                        <h2 class="adminbloodDonor__contentTitle__ID">ID</h2>
                        <h2 class="adminbloodDonor__contentTitle__Profile">Profile</h2>
                        <h2 class="adminbloodDonor__contentTitle__Contact">Contact</h2>
                        <h2 class="adminbloodDonor__contentTitle__BloodType">Blood Type</h2>
                        <div class="adminbloodDonor__contentTitle__empty"></div>
                    </div>
                    <div class="bloodDonor_container">
                        ...
                        <div class="bloodDonor1 bloodDonor">
                            ...
                            <div class="bloodDonor__order">
                                <h1 class="bloodDonor__order__ID">1</h1>
                            </div>
                            <!---PERSONAL INFORMATION--
                            <div class="bloodDonor__personal">
                                <div>
                                    <img class="bloodDonor__personal__Image"
                                        src="../Images/AdminDashboard/profile-default.svg" alt="default profile">
                                </div>
                                <div>
                                    <h3 class="bloodDonor__personal__name">Yughie Perez</h3>
                            ...
                            <div class="bloodDonor__contact">
                                <h3 class="bloodDonor__contact__email">yughiep@gmail.com</h3>
                                <h3 class="bloodDonor__contact__number">092381293241</h3>
                            </div>
                            <!---BLOOD TYPE--
                            <h3 class="bloodDonor__bloodtype">O+</h3>
                            <!---FUNCTIONS----
