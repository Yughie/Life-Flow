                    ...
                    <div class="applicant-select-function_container">
                        <form method="GET" class="searchForm_function"> 
                            <div class="applicant-search-function">
                                ...
                                <input class="applicant-search-input" id="" type="text" name="search" value="<?php echo $searchKeyword; ?>" placeholder="Search">
                        ...
                        <div onclick="sortData('<?php echo $sortOrder; ?>')" class="applicant-sort-function">
