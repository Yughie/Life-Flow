<?php 
    ...
    if (!empty($searchKeyword)) {
        $query .= " WHERE recip_firstName LIKE '%$searchKeyword%' OR recip_lastName LIKE '%$searchKeyword%' OR recip_midName LIKE '%$searchKeyword%'";
    }
                    ...
                    <div class="recipient-select-function_container">
                         <form method="GET" class="searchForm_function"> 
                            <div class="recipient-search-function">
                                <input class="recipient-search-input" type="text" name="search" id="" placeholder="Search">
                        ...
                        <div onclick="sortData('<?php echo $sortOrder; ?>')" class="recipient-sort-function">
